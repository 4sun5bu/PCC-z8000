...
/* operand types for Z8000 */
#define t_reg	1	/* register: .r0-.r15, .rr0-.rr14, .rh0-.rh7, .rl0-.rl7 */
#define t_ireg	2	/* indirect register: @.r1-@.r15 */
#define t_immed 3	/* immediate: #value */
#define t_da	4	/* direct address: symbol or number */
#define t_x	5	/* indexed: offset(.rN) */
#define t_ra	6	/* relative address (for jr/calr/djnz) */
#define t_normal 10	/* general expression value */
#define t_string 11	/* string constant */

/* register sub-types: encoded in reg_o field */
/* word regs:  0-15 = r0-r15 */
/* byte regs:  16-23 = rh0-rh7, 24-31 = rl0-rl7 */
/* long regs:  32-39 = rr0,rr2,...,rr14 (value = 32 + regnum) */
/* quad regs:  48-51 = rq0,rq4,rq8,rq12 (value = 48 + regnum) */
#define BYTE_RH_BASE	16
#define BYTE_RL_BASE	24
#define LONG_RR_BASE	32
#define QUAD_RQ_BASE	48
...
#define IND 0x0B	/* indirection operator -- '@' for Z8000 */
